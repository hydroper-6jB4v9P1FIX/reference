...
The *`deprecated` attribute* marks an item as deprecated. `dsc` will issue
warnings on usage of `#[deprecated]` items. `dsdoc` will show item
...
- [_MetaListNameValueStr_] syntax with two optional fields:
  - `since` — Specifies a version number when the item was deprecated. `dsc`
...
[1270-deprecation.md]: https://github.com/ds-lang/rfcs/blob/master/text/1270-deprecation.md
...
[Clippy]: https://github.com/ds-lang/ds-clippy
...
[dsc book]: ../../dsc/lints/index.html
[dsc-lint-caps]: ../../dsc/lints/levels.html#capping-lints
[dsc-lint-cli]: ../../dsc/lints/levels.html#via-compiler-flag
[dsdoc]: ../../dsdoc/lints.html
