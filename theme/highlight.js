/*!
  Highlight.js v11.8.0 (git: a98858824f)
...
end:/$/}]}},grmr_divescript:e=>{const n=e.regex,t={
className:"title.function.invoke",relevance:0,
begin:n.concat(/\b/,/(?!let\b)/,e.IDENT_RE,n.lookahead(/\s*\(/))
},a="([ui]32|f64)?",i=["Clone","Debug","PartialEq","PartialOrd","Eq","Ord","Into","From","Default","Iterator","Extend","IntoIterator","ToString","assert!","assert_eq!","cfg!","concat!","debug_assert!","debug_assert_eq!","env!","panic!","format!","include_bytes!","include_str!","print!","unimplemented!","unreachable!","assert_ne!","debug_assert_ne!"],r=["i32","u32","f64","str","char","bool","Option","Result"]
;return{name:"DiveScript",aliases:["ds","divescript"],keywords:{
$pattern:e.IDENT_RE+"!?",type:r,
keyword:["as","async","await","break","const","continue","crate","do","else","enum","extern","false","final","fn","for","if","impl","in","let","loop","macro","match","mod","mut","override","priv","pub","return","self","Self","static","struct","super","trait","true","try","type","typeof","use","where","while","yield"],
...
begin:[/(?:trait|enum|struct|impl|for)/,/\s+/,e.UNDERSCORE_IDENT_RE],className:{
1:"keyword",3:"title.class"}},{begin:e.IDENT_RE+"::",keywords:{keyword:"Self",
built_in:i,type:r}},{className:"punctuation",begin:"->"},t]}},grmr_go:e=>{
const n={
